...
public class Display extends JPanel implements KeyListener, MouseListener{
  ...
  private BufferedImage archerSheet, paladinSheet, rogueSheet,fighterSheet, wizardSheet, hunterSheet, enemy, projectile,fireBall, airBall, earthBall, waterBall, darkBall, background,fireExplosion, fireSpell,menuscreen,iceExplosion,iceSpell, airSpell;
  ...
  public Display(final Game game) {
    ...
    try {
     ...
     hunter[(j * cols) + i] = hunterSheet.getSubimage(i * width,j * height,width,height);
      ...
      //archer = resize(ImageIO.read(new File("Archer.png")), Player.getSize(), Player.getSize());// Set the image for the sprite
      ...
      //fighter = resize(ImageIO.read(new File("Fighter.png")), Player.getSize(), Player.getSize());
    ...
    for (int i = 0; i < projectiles.size(); i++){
      ...
      g.drawImage(fireSpell, (projectiles.get(i)).getX()-projectiles.get(i).getWidth()/2,(projectiles.get(i)).getY()-projectiles.get(i).getHeight()/2,this);
       ...
       // g.fillRect((projectiles.get(i)).getX()-25,(projectiles.get(i)).getY()-25,50,50);
        ...
        g.drawImage(iceSpell, (projectiles.get(i)).getX()-25,(projectiles.get(i)).getY()-25,this);
        //g.setColor(Color.BLUE);
       // g.fillRect((projectiles.get(i)).getX()-projectiles.get(i).getWidth()/2,(projectiles.get(i)).getY()-projectiles.get(i).getHeight()/2,projectiles.get(i).getWidth(),projectiles.get(i).getHeight());
       ...
       // g.setColor(Color.BLUE);
        //g.fillRect((projectiles.get(i)).getX()-projectiles.get(i).getWidth()/2,(projectiles.get(i)).getY()-projectiles.get(i).getHeight()/2,projectiles.get(i).getWidth(),projectiles.get(i).getHeight());
      g.drawImage(airSpell, (projectiles.get(i)).getX()-25,(projectiles.get(i)).getY()-25,this);
