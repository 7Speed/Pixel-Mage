...
class Game{
  public void game(){
    Player player = new Archer(750,400,100,100,0);
    ...
    while(true){
      ...
      if (draw.getWPressed() && draw.getDPressed()){//keypress w and d
        player.move(1,player.getSpeed(),enemies,obstacles);
      } else if (draw.getWPressed() && draw.getAPressed()){//keypress wa
        player.move(3,player.getSpeed(),enemies,obstacles);
      } else if (draw.getAPressed() && draw.getSPressed()){//keypress as
        player.move(5,player.getSpeed(),enemies,obstacles);
      } else if (draw.getSPressed() && draw.getDPressed()){//keypress sd
        player.move(7,player.getSpeed(),enemies,obstacles);
      } else if (draw.getDPressed()){//keypress d
        player.move(0,player.getSpeed(),enemies,obstacles);
      } else if (draw.getWPressed()){//keypress w
        player.move(2,player.getSpeed(),enemies,obstacles);
      } else if (draw.getAPressed()){//keypress a
        player.move(4,player.getSpeed(),enemies,obstacles);
      } else if (draw.getSPressed()){//keypress s
        player.move(6,player.getSpeed(),enemies,obstacles);
      }
      ...
      for (int i = 0; i < obstacles.size(); i++){
        ...
        if (obstacles.get(i).getHitbox().intersects(player.getHitbox())){
          ...
          player.move(displaceModifier, enemies, obstacles);
        }
      ...
      for (int i = 0; i < player.getProjectiles().size(); i++){
        ...
        for (int j = 0; j < enemies.size(); j++){
          if ((enemies.get(j).getHitbox().intersects(player.getProjectiles().get(i).getHitbox()))&&((player.getProjectiles().get(i) instanceof FireExplosion)||(player.getProjectiles().get(i) instanceof FireDagger))){//Projectile damages the enemy
            ...
            collision = true;
          } else if ((enemies.get(j).getHitbox().intersects(player.getProjectiles().get(i).getHitbox()))&&((player.getProjectiles().get(i) instanceof IceExplosion)||(player.getProjectiles().get(i) instanceof IceArrow)||(player.getProjectiles().get(i) instanceof IceAura))){
            ...
            collision = true;
          } else if ((enemies.get(j).getHitbox().intersects(player.getProjectiles().get(i).getHitbox()))&&((player.getProjectiles().get(i) instanceof AirArrow)||(player.getProjectiles().get(i) instanceof AirSword))){
        ...
        } else if (player.getProjectiles().get(i) instanceof WaterDash){
        ...
        if (collision && ((player.getProjectiles().get(i) instanceof Arrow)||(player.getProjectiles().get(i) instanceof Sword)||(player.getProjectiles().get(i) instanceof Dagger))){
          if (player.getProjectiles().get(i) instanceof FireArrow){
            player.getProjectiles().add(new FireExplosion(player.getProjectiles().get(i).getX(), player.getProjectiles().get(i).getY()));
          }
          ...
          removeProjectile = true;
          if ((player.getProjectiles().get(i) instanceof AirArrow)||(player.getProjectiles().get(i) instanceof AirSword)){
